...
MODEL                  = LTRTenzo6Dof
MODULES                = LTRTenzo6Dof_capi.c LTRTenzo6Dof_data.c LTRTenzo6Dof_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE               = LTRTenzo6Dof.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2017a
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2017a
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2017a\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/userk/development/github/tenzo-last/Tenzo/Matlab/Thesis/TenzoV1.20/HInf
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/LTRTenzo6Dof \
