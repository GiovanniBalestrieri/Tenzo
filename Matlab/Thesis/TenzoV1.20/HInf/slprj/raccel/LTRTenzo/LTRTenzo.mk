...
MODEL                  = LTRTenzo
MODULES                = LTRTenzo_capi.c LTRTenzo_data.c LTRTenzo_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE               = LTRTenzo.mk
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/LTRTenzo \
