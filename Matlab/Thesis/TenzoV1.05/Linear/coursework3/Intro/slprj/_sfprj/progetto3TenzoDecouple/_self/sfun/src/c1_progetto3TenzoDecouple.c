...
#include "c1_progetto3TenzoDecouple.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "progetto3TenzoDecouple_sfun_debug_macros.h"
...
static void initialize_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void initialize_params_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void enable_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void disable_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void set_sim_state_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void sf_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c1_chartstep_c1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void initSimStructsc1_progetto3TenzoDecouple
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_w4, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[4]);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[136]);
static void c1_b_info_helper(c1_ResolvedFunctionInfo c1_info[136]);
static void c1_c_info_helper(c1_ResolvedFunctionInfo c1_info[136]);
static real_T c1_sqrt(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c1_x);
static void c1_eml_error(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c1_eml_scalar_eg(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c1_realmin(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c1_eps(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c1_eml_int_forloop_overflow_check
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c1_mpower(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c1_c[16]);
static void c1_matrix_to_integer_power(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c1_c[16]);
static void c1_invNxN(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c1_x[16], real_T c1_y[16]);
static void c1_eml_matlab_zgetrf(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4],
  int32_T *c1_info);
static void c1_b_eml_int_forloop_overflow_check
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance, int32_T c1_b);
static void c1_c_eml_int_forloop_overflow_check
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c1_d_eml_int_forloop_overflow_check
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance, int32_T c1_a,
   int32_T c1_b);
static void c1_eml_xgeru(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0,
  int32_T c1_iy0, real_T c1_A[16], int32_T c1_ia0, real_T c1_b_A[16]);
static void c1_eml_xtrsm(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16], real_T c1_b_B[16]);
static void c1_e_eml_int_forloop_overflow_check
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static real_T c1_norm(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c1_x[16]);
static void c1_eml_warning(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c1_b_eml_warning(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, char_T c1_varargin_2[14]);
static void c1_c_eml_scalar_eg(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c1_d_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_sprintf, const char_T *c1_identifier, char_T
  c1_y[14]);
static void c1_e_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  char_T c1_y[14]);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_progetto3TenzoDecouple, const
  char_T *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sqrt(SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T *c1_x);
static void c1_b_eml_matlab_zgetrf(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c1_A[16], int32_T c1_ipiv[4], int32_T *c1_info);
static void c1_b_eml_xgeru(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0,
  int32_T c1_iy0, real_T c1_A[16], int32_T c1_ia0);
static void c1_b_eml_xtrsm(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16]);
static void init_dsm_address_info(SFc1_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
  ...
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_progetto3TenzoDecouple = 0U;
}
  ...
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_progetto3TenzoDecouple;
   ...
   *c1_st)
{
  ...
  *c1_w4 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
    "w4");
  chartInstance->c1_is_active_c1_progetto3TenzoDecouple = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_progetto3TenzoDecouple");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_progetto3TenzoDecouple(chartInstance);
  ...
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_progetto3TenzoDecouple(chartInstance);
  sf_debug_check_for_state_inconsistency(_progetto3TenzoDecoupleMachineNumber_,
  ...
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  c1_b_sqrt(chartInstance, &c1_w0c);
  ...
  for (c1_i3 = 0; c1_i3 < 4; c1_i3++) {
    c1_C[c1_i3] = c1_T[c1_i3];
  }

  for (c1_i4 = 0; c1_i4 < 4; c1_i4++) {
    c1_T[c1_i4] = c1_C[c1_i4];
  }

  for (c1_i5 = 0; c1_i5 < 4; c1_i5++) {
    c1_C[c1_i5] = c1_T[c1_i5];
  }

  for (c1_i6 = 0; c1_i6 < 4; c1_i6++) {
    c1_T[c1_i6] = c1_C[c1_i6];
  }
  ...
  for (c1_i7 = 0; c1_i7 < 4; c1_i7++) {
    ...
    for (c1_i9 = 0; c1_i9 < 4; c1_i9++) {
      c1_T[c1_i7] += c1_a[c1_i8 + c1_i7] * c1_b[c1_i9];
      c1_i8 += 4;
    }
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance;
  chartInstance = (SFc1_progetto3TenzoDecoupleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_progetto3TenzoDecouple_get_eml_resolved_functions_info(void)
{
  const mxArray *c1_nameCaptureInfo;
  c1_ResolvedFunctionInfo c1_info[136];
  ...
  sf_mex_assign(&c1_m0, sf_mex_createstruct("nameCaptureInfo", 1, 136), FALSE);
  for (c1_i20 = 0; c1_i20 < 136; c1_i20++) {
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[136])
{
  ...
  c1_info[12].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c1_info[12].fileTimeLo = 1286818726U;
  ...
  c1_info[17].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[17].fileTimeLo = 1289519692U;
  ...
  c1_info[22].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[22].fileTimeLo = 1289519692U;
  ...
  c1_info[25].fileTimeLo = 1305318000U;
  ...
  c1_info[31].fileTimeLo = 1307651244U;
  ...
  c1_info[32].fileTimeLo = 1307651242U;
  ...
  c1_info[33].fileTimeLo = 1307651240U;
  ...
  c1_info[40].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c1_info[40].fileTimeLo = 1286818796U;
  ...
  c1_info[42].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c1_info[42].fileTimeLo = 1286818796U;
  ...
  c1_info[49].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/elmat/intmin.m";
  c1_info[49].fileTimeLo = 1311255318U;
  ...
  c1_info[58].fileTimeLo = 1311255316U;
  ...
  c1_info[61].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  c1_info[61].name = "eml_index_plus";
  ...
  c1_info[62].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  c1_info[62].fileTimeLo = 1311255316U;
...
static void c1_b_info_helper(c1_ResolvedFunctionInfo c1_info[136])
{
  ...
  c1_info[71].fileTimeLo = 1299076770U;
  ...
  c1_info[74].fileTimeLo = 1286818694U;
  ...
  c1_info[75].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c1_info[75].fileTimeLo = 1286818712U;
  ...
  c1_info[76].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  c1_info[76].fileTimeLo = 1311255316U;
  ...
  c1_info[77].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c1_info[77].fileTimeLo = 1286818778U;
  ...
  c1_info[78].fileTimeLo = 1299076778U;
  ...
  c1_info[91].name = "intmax";
  c1_info[91].dominantType = "char";
  c1_info[91].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[91].fileTimeLo = 1311255316U;
  ...
  c1_info[97].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[97].fileTimeLo = 1289519692U;
  ...
  c1_info[100].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgerx.m";
  c1_info[100].name = "eml_index_class";
  ...
  c1_info[101].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgerx.m";
  c1_info[101].name = "abs";
  c1_info[101].dominantType = "int32";
  c1_info[101].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/elfun/abs.m";
  c1_info[101].fileTimeLo = 1286818694U;
  ...
  c1_info[103].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgerx.m";
  c1_info[103].name = "eml_int_forloop_overflow_check";
  c1_info[103].dominantType = "";
  c1_info[103].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  c1_info[103].fileTimeLo = 1311255316U;
  ...
  c1_info[105].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/matfun/inv.m!invNxN";
  c1_info[105].name = "eml_ipiv2perm";
  ...
  c1_info[114].resolved =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[114].fileTimeLo = 1289519692U;
  ...
  c1_info[118].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m";
  c1_info[118].name = "eml_index_minus";
...
static void c1_c_info_helper(c1_ResolvedFunctionInfo c1_info[136])
{
  c1_info[128].context =
    "[ILXE]/home/userk/Programs/Matlab/toolbox/eml/lib/matlab/matfun/norm.m!mat1norm";
  c1_info[128].name = "eml_guarded_nan";
...
{
  int32_T c1_i22;
  static real_T c1_dv2[16] = { 0.0, 8.0834517164645556E-6, 4.3325606937667151E-7,
    -0.00028067540682168596, -8.0834517164645556E-6, 0.0, -4.3325606937667151E-7,
    -0.00028067540682168596, 0.0, -8.0834517164645556E-6, 4.3325606937667151E-7,
    -0.00028067540682168596, 8.0834517164645556E-6, 0.0, -4.3325606937667151E-7,
    -0.00028067540682168596 };
  ...
  do {
    ...
    if (c1_y != c1_e) {
      if (c1_firstmult) {
        ...
        for (c1_i24 = 0; c1_i24 < 16; c1_i24++) {
          c1_A[c1_i24] = c1_c[c1_i24];
        }

        for (c1_i25 = 0; c1_i25 < 4; c1_i25++) {
          c1_i26 = 0;
          for (c1_i27 = 0; c1_i27 < 4; c1_i27++) {
            c1_c[c1_i26 + c1_i25] = 0.0;
            c1_i28 = 0;
            for (c1_i29 = 0; c1_i29 < 4; c1_i29++) {
              c1_c[c1_i26 + c1_i25] += c1_A[c1_i28 + c1_i25] * c1_a[c1_i29 +
                c1_i26];
              c1_i28 += 4;
            }
    ...
    if (c1_ed2 == 0.0) {
      ...
      for (c1_i36 = 0; c1_i36 < 16; c1_i36++) {
        c1_A[c1_i36] = c1_a[c1_i36];
      }

      for (c1_i37 = 0; c1_i37 < 4; c1_i37++) {
        c1_i38 = 0;
        for (c1_i39 = 0; c1_i39 < 4; c1_i39++) {
          c1_a[c1_i38 + c1_i37] = 0.0;
          c1_i40 = 0;
          for (c1_i41 = 0; c1_i41 < 4; c1_i41++) {
            c1_a[c1_i38 + c1_i37] += c1_A[c1_i40 + c1_i37] * c1_A[c1_i41 +
              c1_i38];
            c1_i40 += 4;
          }
  ...
  for (c1_c_k = 1; c1_c_k < 5; c1_c_k++) {
    ...
    for (c1_j = c1_e_k; c1_j < 5; c1_j++) {
      ...
      if (c1_y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        c1_a = c1_b_j + 1;
        c1_i44 = c1_a;
        c1_d_eml_int_forloop_overflow_check(chartInstance, c1_i44, 4);
        for (c1_i = c1_i44; c1_i < 5; c1_i++) {
          c1_b_i = c1_i;
  ...
  (SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance, int32_T c1_b)
{
  ...
  if (c1_safe) {
    ...
    for (c1_i47 = 0; c1_i47 < 34; c1_i47++) {
      c1_u[c1_i47] = c1_cv1[c1_i47];
    }
   ...
   int32_T c1_b)
{
  ...
  if (c1_safe) {
    ...
    for (c1_i49 = 0; c1_i49 < 34; c1_i49++) {
      c1_u[c1_i49] = c1_cv3[c1_i49];
    }
  ...
  *chartInstance, char_T c1_varargin_2[14])
{
  ...
  for (c1_i56 = 0; c1_i56 < 14; c1_i56++) {
    c1_b_u[c1_i56] = c1_varargin_2[c1_i56];
  }
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_progetto3TenzoDecouple), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_progetto3TenzoDecouple);
  return c1_y;
}
  ...
  *c1_info = 0;
  ...
  for (c1_j = 1; c1_j < 4; c1_j++) {
    ...
    if (c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      c1_m_a = c1_jp1j;
      c1_g_b = c1_d_c - 1;
      c1_i60 = c1_m_a + c1_g_b;
      c1_d_eml_int_forloop_overflow_check(chartInstance, c1_b_jp1j, c1_i60);
      for (c1_i = c1_b_jp1j; c1_i <= c1_i60; c1_i++) {
        c1_b_i = c1_i;
  ...
  if (c1_e_alpha1 == 0.0) {
    ...
    for (c1_j = 1; c1_j <= c1_loop_ub; c1_j++) {
      ...
      if (c1_yjy != 0.0) {
        ...
        c1_b_a = c1_e_m;
        c1_b_b = c1_jA;
        c1_i62 = c1_b_a + c1_b_b;
        c1_d_eml_int_forloop_overflow_check(chartInstance, c1_i61, c1_i62);
        for (c1_ijA = c1_i61; c1_ijA <= c1_i62; c1_ijA++) {
          c1_b_ijA = c1_ijA;
          c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
  ...
  for (c1_j = 1; c1_j < 5; c1_j++) {
    ...
    for (c1_k = 4; c1_k > 0; c1_k--) {
      ...
      if (c1_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        c1_g_a = c1_b_k - 1;
        c1_i63 = c1_g_a;
        c1_d_eml_int_forloop_overflow_check(chartInstance, 1, c1_i63);
        for (c1_i = 1; c1_i <= c1_i63; c1_i++) {
          c1_b_i = c1_i;
          c1_h_a = c1_b_i;
          c1_i_b = c1_jBcol;
...
/* SFunction Glue Code */
void sf_c1_progetto3TenzoDecouple_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_progetto3TenzoDecouple_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_progetto3TenzoDecouple(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"w1\",},{M[1],M[9],T\"w2\",},{M[1],M[10],T\"w3\",},{M[1],M[11],T\"w4\",},{M[8],M[0],T\"is_active_c1_progetto3TenzoDecouple\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_progetto3TenzoDecouple_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance;
    chartInstance = (SFc1_progetto3TenzoDecoupleInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_progetto3TenzoDecoupleMachineNumber_,
           1,
           1,
           1,
           8,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_progetto3TenzoDecoupleMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_progetto3TenzoDecoupleMachineNumber_,chartInstance->chartNumber,1);
      ...
      sf_debug_reset_current_state_configuration
        (_progetto3TenzoDecoupleMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_progetto3TenzoDecouple(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_progetto3TenzoDecouple
    ((SFc1_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
  initialize_c1_progetto3TenzoDecouple
    ((SFc1_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_progetto3TenzoDecouple(void *chartInstanceVar)
{
  enable_c1_progetto3TenzoDecouple((SFc1_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_progetto3TenzoDecouple(void *chartInstanceVar)
{
  disable_c1_progetto3TenzoDecouple((SFc1_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_progetto3TenzoDecouple(void *chartInstanceVar)
{
  sf_c1_progetto3TenzoDecouple((SFc1_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_progetto3TenzoDecouple
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_progetto3TenzoDecouple
    ((SFc1_progetto3TenzoDecoupleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_progetto3TenzoDecouple();/* state var info */
...
extern void sf_internal_set_sim_state_c1_progetto3TenzoDecouple(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_progetto3TenzoDecouple
    ((SFc1_progetto3TenzoDecoupleInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_progetto3TenzoDecouple
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_progetto3TenzoDecouple(S);
}

static void sf_opaque_set_sim_state_c1_progetto3TenzoDecouple(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_progetto3TenzoDecouple(S, st);
}

static void sf_opaque_terminate_c1_progetto3TenzoDecouple(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_progetto3TenzoDecoupleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_progetto3TenzoDecouple
      ((SFc1_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_progetto3TenzoDecouple_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc1_progetto3TenzoDecouple
    ((SFc1_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_progetto3TenzoDecouple(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_progetto3TenzoDecouple
      ((SFc1_progetto3TenzoDecoupleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_progetto3TenzoDecouple(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_progetto3TenzoDecouple_optimization_info();
...
static void mdlRTW_c1_progetto3TenzoDecouple(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_progetto3TenzoDecouple(SimStruct *S)
{
  SFc1_progetto3TenzoDecoupleInstanceStruct *chartInstance;
  chartInstance = (SFc1_progetto3TenzoDecoupleInstanceStruct *)malloc(sizeof
    (SFc1_progetto3TenzoDecoupleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_progetto3TenzoDecoupleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_progetto3TenzoDecouple;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_progetto3TenzoDecouple;
...
void c1_progetto3TenzoDecouple_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_progetto3TenzoDecouple(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_progetto3TenzoDecouple(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_progetto3TenzoDecouple(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_progetto3TenzoDecouple_method_dispatcher.\n"
