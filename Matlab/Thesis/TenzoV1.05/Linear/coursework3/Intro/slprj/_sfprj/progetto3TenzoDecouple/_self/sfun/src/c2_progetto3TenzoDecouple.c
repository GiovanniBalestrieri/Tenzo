...
static void initialize_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void initialize_params_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void enable_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void disable_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void set_sim_state_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void sf_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c2_chartstep_c2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void initSimStructsc2_progetto3TenzoDecouple
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_w4, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
...
static real_T c2_sqrt(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c2_x);
static void c2_eml_error(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c2_eml_scalar_eg(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c2_realmin(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c2_eps(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c2_eml_int_forloop_overflow_check
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c2_mpower(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c2_c[16]);
static void c2_matrix_to_integer_power(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c2_c[16]);
static void c2_invNxN(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c2_x[16], real_T c2_y[16]);
static void c2_eml_matlab_zgetrf(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c2_A[16], real_T c2_b_A[16], int32_T c2_ipiv[4],
  int32_T *c2_info);
static void c2_b_eml_int_forloop_overflow_check
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance, int32_T c2_b);
static void c2_c_eml_int_forloop_overflow_check
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static void c2_d_eml_int_forloop_overflow_check
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance, int32_T c2_a,
   int32_T c2_b);
static void c2_eml_xgeru(SFc2_progetto3TenzoDecoupleInstanceStruct
...
static void c2_eml_xtrsm(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c2_A[16], real_T c2_B[16], real_T c2_b_B[16]);
static void c2_e_eml_int_forloop_overflow_check
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance);
static real_T c2_norm(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T c2_x[16]);
static void c2_eml_warning(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c2_b_eml_warning(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, char_T c2_varargin_2[14]);
static void c2_c_eml_scalar_eg(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
static void c2_d_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_sprintf, const char_T *c2_identifier, char_T
  c2_y[14]);
static void c2_e_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  char_T c2_y[14]);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_progetto3TenzoDecouple, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance,
                      real_T *c2_x);
static void c2_b_eml_matlab_zgetrf(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c2_A[16], int32_T c2_ipiv[4], int32_T *c2_info);
static void c2_b_eml_xgeru(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0,
  int32_T c2_iy0, real_T c2_A[16], int32_T c2_ia0);
static void c2_b_eml_xtrsm(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance, real_T c2_A[16], real_T c2_B[16]);
static void init_dsm_address_info(SFc2_progetto3TenzoDecoupleInstanceStruct
  *chartInstance);
  ...
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_progetto3TenzoDecouple = 0U;
}
  ...
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  c2_e_hoistedGlobal = chartInstance->c2_is_active_c2_progetto3TenzoDecouple;
   ...
   *c2_st)
{
  ...
  *c2_w4 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
    "w4");
  chartInstance->c2_is_active_c2_progetto3TenzoDecouple = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
     "is_active_c2_progetto3TenzoDecouple");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_progetto3TenzoDecouple(chartInstance);
  ...
  (SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_progetto3TenzoDecouple(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance;
  chartInstance = (SFc2_progetto3TenzoDecoupleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_progetto3TenzoDecouple_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_progetto3TenzoDecouple), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_progetto3TenzoDecouple);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_progetto3TenzoDecouple_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_progetto3TenzoDecouple_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_progetto3TenzoDecouple(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"w1\",},{M[1],M[9],T\"w2\",},{M[1],M[10],T\"w3\",},{M[1],M[11],T\"w4\",},{M[8],M[0],T\"is_active_c2_progetto3TenzoDecouple\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_progetto3TenzoDecouple_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance;
    chartInstance = (SFc2_progetto3TenzoDecoupleInstanceStruct *)
...
static void sf_opaque_initialize_c2_progetto3TenzoDecouple(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_progetto3TenzoDecouple
    ((SFc2_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
  initialize_c2_progetto3TenzoDecouple
    ((SFc2_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_progetto3TenzoDecouple(void *chartInstanceVar)
{
  enable_c2_progetto3TenzoDecouple((SFc2_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_progetto3TenzoDecouple(void *chartInstanceVar)
{
  disable_c2_progetto3TenzoDecouple((SFc2_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_progetto3TenzoDecouple(void *chartInstanceVar)
{
  sf_c2_progetto3TenzoDecouple((SFc2_progetto3TenzoDecoupleInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_progetto3TenzoDecouple
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_progetto3TenzoDecouple
    ((SFc2_progetto3TenzoDecoupleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_progetto3TenzoDecouple();/* state var info */
...
extern void sf_internal_set_sim_state_c2_progetto3TenzoDecouple(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_progetto3TenzoDecouple
    ((SFc2_progetto3TenzoDecoupleInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_progetto3TenzoDecouple
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_progetto3TenzoDecouple(S);
}

static void sf_opaque_set_sim_state_c2_progetto3TenzoDecouple(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_progetto3TenzoDecouple(S, st);
}

static void sf_opaque_terminate_c2_progetto3TenzoDecouple(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_progetto3TenzoDecoupleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_progetto3TenzoDecouple
      ((SFc2_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_progetto3TenzoDecouple
    ((SFc2_progetto3TenzoDecoupleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_progetto3TenzoDecouple(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_progetto3TenzoDecouple
      ((SFc2_progetto3TenzoDecoupleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_progetto3TenzoDecouple(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_progetto3TenzoDecouple(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_progetto3TenzoDecouple(SimStruct *S)
{
  SFc2_progetto3TenzoDecoupleInstanceStruct *chartInstance;
  chartInstance = (SFc2_progetto3TenzoDecoupleInstanceStruct *)malloc(sizeof
    (SFc2_progetto3TenzoDecoupleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_progetto3TenzoDecoupleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_progetto3TenzoDecouple;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_progetto3TenzoDecouple;
...
void c2_progetto3TenzoDecouple_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_progetto3TenzoDecouple(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_progetto3TenzoDecouple(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_progetto3TenzoDecouple(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_progetto3TenzoDecouple_method_dispatcher.\n"
