...
MAKECMD         = /home/sashimono/programs/matlab/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = PhiTheta
MODULES                = PhiTheta_capi.c PhiTheta_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c 
MAKEFILE               = PhiTheta.mk
MATLAB_ROOT            = /home/sashimono/programs/matlab
ALT_MATLAB_ROOT        = /home/sashimono/programs/matlab
MATLAB_ROOTQ           = \"/home/sashimono/programs/matlab\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/sashimono/development/github/Tenzo/Matlab/Thesis/TenzoDynamics/Decoupled
S_FUNCTIONS            = rtiostream_utils.c
S_FUNCTIONS_LIB        = 
COMPUTER               = GLNXA64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/home/sashimono/programs/matlab" EXT_MODE=1 OPTS="-DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/PhiTheta \
	-I$(START_DIR) \
