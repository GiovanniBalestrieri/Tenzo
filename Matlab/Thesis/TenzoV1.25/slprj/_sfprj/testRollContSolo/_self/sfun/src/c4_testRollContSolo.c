...
static const char * c4_debug_family_names[12] = { "Radius", "Radius_in", "Ct",
  "rho", "Aprop", "Thrust_newton", "Thrust_kg", "nargin", "nargout", "rpm",
  "wlin", "force" };

/* Function Declarations */
static void initialize_c4_testRollContSolo(SFc4_testRollContSoloInstanceStruct
  *chartInstance);
static void initialize_params_c4_testRollContSolo
  (SFc4_testRollContSoloInstanceStruct *chartInstance);
static void enable_c4_testRollContSolo(SFc4_testRollContSoloInstanceStruct
  *chartInstance);
static void disable_c4_testRollContSolo(SFc4_testRollContSoloInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_testRollContSolo
  (SFc4_testRollContSoloInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_testRollContSolo
  (SFc4_testRollContSoloInstanceStruct *chartInstance);
static void set_sim_state_c4_testRollContSolo
  (SFc4_testRollContSoloInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_testRollContSolo(SFc4_testRollContSoloInstanceStruct
  *chartInstance);
static void sf_gateway_c4_testRollContSolo(SFc4_testRollContSoloInstanceStruct
  *chartInstance);
static void initSimStructsc4_testRollContSolo
  (SFc4_testRollContSoloInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_testRollContSoloInstanceStruct
  *chartInstance, const mxArray *c4_force, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_testRollContSoloInstanceStruct
...
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_testRollContSoloInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_testRollContSoloInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_testRollContSolo, const
  char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_testRollContSoloInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_testRollContSoloInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_testRollContSolo = 0U;
}
  ...
  (SFc4_testRollContSoloInstanceStruct *chartInstance)
{
  ...
  real_T *c4_force;
  c4_force = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellmatrix(2, 1), false);
  c4_hoistedGlobal = *c4_force;
  c4_u = c4_hoistedGlobal;
  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c4_y, 0, c4_b_y);
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_testRollContSolo;
  ...
  (SFc4_testRollContSoloInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_force = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    0)), "force");
  chartInstance->c4_is_active_c4_testRollContSolo = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_testRollContSolo");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_testRollContSolo(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c4_b_rpm;
  real_T *c4_b_force;
  c4_b_wlin = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_force = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_rpm = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c4_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c4_b_rpm, 0U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_rpm;
  c4_b_hoistedGlobal = *c4_b_wlin;
  c4_rpm = c4_hoistedGlobal;
  c4_wlin = c4_b_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 12U, 12U, c4_debug_family_names,
    c4_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_Radius, 0U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Radius_in, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_Ct, 2U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_rho, 3U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_Aprop, 4U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Thrust_newton, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Thrust_kg, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 8U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_rpm, 9U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_wlin, 10U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_force, 11U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c4_Thrust_newton = 0.009161237607041366 * c4_rpm * 2.0 * c4_wlin * 0.013225;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 14);
  c4_A = c4_Thrust_newton;
  c4_x = c4_A;
  c4_b_x = c4_x;
  c4_c_x = c4_b_x;
  c4_Thrust_kg = c4_c_x / 9.81;
  sf_mex_printf("%s =\\n", "Thrust_kg");
  c4_f_u = c4_Thrust_kg;
  c4_f_y = NULL;
  sf_mex_assign(&c4_f_y, sf_mex_create("y", &c4_f_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c4_f_y);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 17);
  c4_force = c4_Thrust_newton;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -17);
  ...
  *c4_b_force = c4_force;
  ...
  _SFD_DATA_RANGE_CHECK(*c4_b_force, 1U);
  _SFD_DATA_RANGE_CHECK(*c4_b_wlin, 2U);
}
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_testRollContSoloInstanceStruct *chartInstance;
  chartInstance = (SFc4_testRollContSoloInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c4_force, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_force), &c4_thisId);
  sf_mex_destroy(&c4_force);
  return c4_y;
}
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_force;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_testRollContSoloInstanceStruct *chartInstance;
  chartInstance = (SFc4_testRollContSoloInstanceStruct *)chartInstanceVoid;
  c4_force = sf_mex_dup(c4_mxArrayInData);
...
const mxArray *sf_c4_testRollContSolo_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_testRollContSolo), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_testRollContSolo);
  return c4_y;
}
...
void sf_c4_testRollContSolo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_testRollContSolo_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_testRollContSolo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_testRollContSolo_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_testRollContSolo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"force\",},{M[8],M[0],T\"is_active_c4_testRollContSolo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_testRollContSolo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_testRollContSoloInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c4_force;
          real_T *c4_wlin;
          c4_wlin = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c4_force = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c4_rpm = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c4_rpm);
          _SFD_SET_DATA_VALUE_PTR(1U, c4_force);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_wlin);
        }
      }
    } else {
...
static void sf_opaque_initialize_c4_testRollContSolo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar);
  initialize_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_testRollContSolo(void *chartInstanceVar)
{
  enable_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_testRollContSolo(void *chartInstanceVar)
{
  disable_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_testRollContSolo(void *chartInstanceVar)
{
  sf_gateway_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_testRollContSolo(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_testRollContSolo
    ((SFc4_testRollContSoloInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_testRollContSolo();/* state var info */
...
extern void sf_internal_set_sim_state_c4_testRollContSolo(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_testRollContSolo();/* state var info */
  ...
  set_sim_state_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_testRollContSolo(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_testRollContSolo(S);
}

static void sf_opaque_set_sim_state_c4_testRollContSolo(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_testRollContSolo(S, st);
}

static void sf_opaque_terminate_c4_testRollContSolo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_testRollContSoloInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_testRollContSolo((SFc4_testRollContSoloInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_testRollContSolo(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_testRollContSolo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_testRollContSolo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_testRollContSolo(SimStruct *S)
{
  SFc4_testRollContSoloInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_testRollContSoloInstanceStruct *)utMalloc(sizeof
    (SFc4_testRollContSoloInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_testRollContSoloInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_testRollContSolo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_testRollContSolo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_testRollContSolo;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_testRollContSolo;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_testRollContSolo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_testRollContSolo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_testRollContSolo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_testRollContSolo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_testRollContSolo;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_testRollContSolo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_testRollContSolo;
...
void c4_testRollContSolo_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_testRollContSolo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_testRollContSolo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_testRollContSolo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_testRollContSolo_method_dispatcher.\n"
