...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2500352471U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(24120322U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2229552285U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1257341986U);
}
...
mxArray *sf_c1_tenzo6dof_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iOoPIJDDY5tSYXlH6lw1WC");
...
static void mdlSetWorkWidths_c1_tenzo6dof(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1638383554U));
  ssSetChecksum1(S,(2379306595U));
  ssSetChecksum2(S,(2395205920U));
  ssSetChecksum3(S,(1219233491U));
