...
%             Ydata = [ Ydata(2:end) ; YFilt ]; 
            ...
            hold on;
            plot(index,EKXdata,'b-','LineWidth',1);
            hold off;
            xlabel('Time');
            ylabel('Theta (deg)');
            ...
            grid on;
            title('pitch in deg');
            plot(index,Pdata,'r','LineWidth',2);%,'MarkerEdgeColor','k','MarkerFaceColor','g','MarkerSize',5);
            hold on;
            plot(index,EKYdata,'b-','LineWidth',1);
            hold off;
            xlabel('Time');
            ylabel('phi in deg');
            axis([1 buf_len -50 50]);
            ...
            title('Yaw in deg');
            %hold on;
            plot(index,Ydata,'r','LineWidth',2);%,'MarkerEdgeColor','k','MarkerFaceColor','g','MarkerSize',5);
