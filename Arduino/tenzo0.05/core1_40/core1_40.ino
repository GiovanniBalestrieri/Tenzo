...
//        float consKpRoll=3.00, consKiRoll=2, consKdRoll=0.03;
        ...
        // Aggressive settings theta >= thre     
        float aggKpCascPitch=2.5, aggKiCascPitch=0.00, aggKdCascPitch=0.00;
        // Conservative settings theta < thre
        float consKpCascPitch=2.5, consKiCascPitch=0.00, consKdCascPitch=0.00; //1.5 / 3.2 0.6 0.4
        
        // W part   
        float consKpCascPitchW=0.7, consKiCascPitchW=0.01, consKdCascPitchW=0.5;   
...
void changePidState(boolean cond)
{
  ...
  { 
    ...
    OutputCascPitch = 0,OutputCascPitch = 0;
