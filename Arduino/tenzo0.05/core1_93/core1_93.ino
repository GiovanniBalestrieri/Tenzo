...
//        float consKpRoll=3.00, consKiRoll=2, consKdRoll=0.03;
        ...
        float aggKpCascRoll=1.19, aggKiCascRoll=1.11, aggKdCascRoll=0.93;
        // Conservative settings theta < thre
        float consKpCascRoll=4.63, consKiCascRoll=1.01, consKdCascRoll=0.93; //1.5 / 3.2 0.6 0.4
        
        // W part   
        //float consKpCascRollW=1.28, consKiCascRollW=1.30, consKdCascRollW=0.10;  // Expensive 
        float consKpCascRollW=0.75, consKiCascRollW=0.30, consKdCascRollW=0.10;  // Expensive 
