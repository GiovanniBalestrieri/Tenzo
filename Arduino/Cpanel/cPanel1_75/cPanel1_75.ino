...
double Setpoint = 0, errorRoll, Output;
...
PID myPID(&errorRoll, &Output, &Setpoint, consKp, consKi, consKd, DIRECT);
...
float alphaA_xy = 0.02;  //use 'a' to increse and 'z' to decrease
float alphaA_z  = 0.01;  //use 'h' to increase 'n' to decrease
