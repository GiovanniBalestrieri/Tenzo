...
// Pitch
double aggKpPitch=0.10, aggKiPitch=0.06, aggKdPitch=0.04;
double consKpPitch=0.22, consKiPitch=0.09, consKdPitch=0.02;
...
unsigned long timeToLand = 10000;
