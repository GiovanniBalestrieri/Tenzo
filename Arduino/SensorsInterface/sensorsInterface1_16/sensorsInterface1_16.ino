...
void setup()
{
  ...
  kalmanX.setRmeasure(3); // Measurement noise variance 
  kalmanY.setRmeasure(3); // Measurement noise variance
...
{  
  ...
  {  //is there anything to read
    ...
    {    
      ...
      xbee.print(bearing1);
      /*
      // Send Complementary Filer Angular position values
      xbee.print(',');
      xbee.print('CR');
      xbee.print(',');
      xbee.print(compAngleX);
      xbee.print(',');
      xbee.print('CP');
      xbee.print(',');
      xbee.print(compAngleY);
      */
 ...
 */
 ...
 xAngle = kalmanX.getAngle(angleXAcc,wx,(double)(micros() - timerMu));
 yAngle = kalmanY.getAngle(angleYAcc,wy,(double)(micros() - timerMu)) + 6;
 yAngle = -yAngle;
