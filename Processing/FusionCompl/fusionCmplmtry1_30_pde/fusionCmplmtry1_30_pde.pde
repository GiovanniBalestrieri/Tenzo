...
void SerialRoutine()
{
 ...
 {  
    ...
    if (val!=null)
    {
      ...
      if (!plotOK)
      { 
        if (val.charAt(0)=='P' && val.charAt(1)=='P' )
        { 
          plotOK = true;
        }
      }
     ...
     { 
      ...
      {
        println("Acc - Gyro - Fusion ");
        rpy[0] =  Float.parseFloat(vals[1]);
        rpy[1] =  Float.parseFloat(vals[2]);
        rpy[2] =  Float.parseFloat(vals[3]);
        rpy[3] =  Float.parseFloat(vals[4]);
        rpy[4] =  Float.parseFloat(vals[5]);
        rpy[5] =  Float.parseFloat(vals[6]);
        rpy[6] =  Float.parseFloat(vals[7]);
        rpy[7] =  Float.parseFloat(vals[8]);
        // Acc
        accRotz = -rpy[3]*PI/180;
        accRotx = -rpy[4]*PI/180;
        // Gyro
